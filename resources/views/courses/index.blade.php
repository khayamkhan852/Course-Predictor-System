                                        ...
                                        @if(auth()->user()->can('courses.update') || auth()->user()->can('courses.delete'))
                                            <td class="text-center">
                                                ...
                                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true" style="">
                                                    <div class="menu-item px-3"><a href="{{ route('courses.show', [$course]) }}" class="menu-link px-3">View</a></div>
                                                    @can('departments.update')
                                                        <div class="menu-item px-3"><a href="{{ route('courses.edit', [$course]) }}" class="menu-link px-3">Edit</a></div>
                                                    @endcan
