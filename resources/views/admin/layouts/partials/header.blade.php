        ...
        <div class="topbar d-flex align-items-stretch">
            ...
            <div class="d-flex align-items-center me-2 me-lg-4">
                ...
                <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px" data-kt-menu="true">
                    <div class="d-flex flex-column bgi-no-repeat rounded-top" style="background-image:url('{{ asset('theme/assets/media/misc/menu-header-bg.jpg') }}')">
                        ...
                        <a href="#" class="menu-link px-5">
                            <span class="menu-title position-relative">Language
                                <span class="fs-8 rounded bg-light px-3 py-2 position-absolute translate-middle-y top-50 end-0">English
                                    <img class="w-15px h-15px rounded-1 ms-2" src="{{ asset('theme/assets/media/flags/united-states.svg') }}" alt="" />
                                </span>
                            </span>
                        </a>
            ...
            <!--begin::Item-->
            <div class="d-flex align-items-center me-2 me-lg-4">
                <a href="#" class="btn btn-success border-0 px-3 px-lg-6" data-bs-toggle="modal" data-bs-target="#model_id">New Reservation</a>
            </div>
            <!--end::Item-->
        </div>
        <!--end::Topbar-->
