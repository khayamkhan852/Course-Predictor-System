    ...
    <div class="aside-menu flex-column-fluid ps-5 pe-3 mb-7" id="kt_aside_menu">
        <div class="w-100 hover-scroll-overlay-y d-flex pe-2" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_aside_footer, #kt_header" data-kt-scroll-wrappers="#kt_aside, #kt_aside_menu, #kt_aside_menu_wrapper" data-kt-scroll-offset="102">
            <div class="menu menu-column menu-rounded menu-sub-indention menu-active-bg fw-semibold my-auto" id="#kt_aside_menu" data-kt-menu="true">
                ...
                @if(auth()->user()->can('vehicle.view') || auth()->user()->can('vehicle.create') || auth()->user()->can('vehicle.update') || auth()->user()->can('vehicle.delete') || auth()->user()->can('vehicle.disable'))
                    <div data-kt-menu-trigger="click" class="menu-item here {{ request()->routeIs('admin.operations.*') ? 'show' : '' }} menu-accordion">
                        ...
                        @if(auth()->user()->can('vehicle.view') || auth()->user()->can('vehicle.create') || auth()->user()->can('vehicle.update') || auth()->user()->can('vehicle.delete') || auth()->user()->can('vehicle.disable'))
                            <div class="menu-sub menu-sub-accordion">
                                <div class="menu-item">
                                    <a class="menu-link {{ request()->routeIs('admin.operations.vehicles.*') ? 'active' : '' }}" href="{{ route('admin.operations.vehicles.index') }}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                        ...
                        @endif
                        <div class="menu-sub menu-sub-accordion">
                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion {{ request()->routeIs('admin.operations.customers.*') ? 'here show' : '' }} mb-1">
                            <span class="menu-link">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                                ...
                                <div class="menu-sub menu-sub-accordion">
                                    <div class="menu-item">
                                        <a class="menu-link {{ request()->routeIs('admin.operations.customers.*') ? 'active' : '' }}" href="{{ route('admin.operations.customers.index') }}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link {{ request()->routeIs('admin.operations.customers.type.*') ? 'active' : '' }}" href="{{ route('admin.operations.customers.type.index') }}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link {{ request()->routeIs('admin.operations.customers.status.*') ? 'active' : '' }}" href="{{ route('admin.operations.customers.status.index') }}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                        ...
                        <div class="menu-sub menu-sub-accordion">
                            <div class="menu-item">
                                ...
                                <span class="menu-bullet">
                                    ...
                                    <span class="menu-title">Black List</span>
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        <div class="menu-item">
                            <a class="menu-link" href="#">
                                ...
                                <span class="menu-title">Vehicle Earning</span>
                            </a>
                        </div>
                    </div>
                </div>
