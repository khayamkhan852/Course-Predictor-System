        ...
        <div class="card">
            <div class="card-body">
                <div class="stepper stepper-links d-flex flex-column">
                    ...
                    <form class="mx-auto w-100 pt-10 pb-10" id="add_vehicle_form" enctype="multipart/form-data" data-vehicle_id="{{ $vehicle->id }}">
                        <div class="form-steps">
                            <div id="step-1" class="step" data-for-header="header1">
                                @include('admin.vehicle.edit.partials.step-one')
                            </div>
                            <div id="step-2" class="step" data-for-header="header2" style="display: none;">
                                @include('admin.vehicle.edit.partials.step-two')
                            </div>
                            <div id="step-3" class="step" data-for-header="header3" style="display: none;">
                                @include('admin.vehicle.edit.partials.step-three')
                            </div>
                            <div id="step-4" class="step" data-for-header="header4" style="display: none;">
                                @include('admin.vehicle.edit.partials.step-four')
                            </div>
                        </div>
                        ...
                        <div class="d-flex flex-stack pt-15">
                            ...
                            <div>
                                <button type="submit" class="btn btn-lg btn-primary me-3" id="submit-btn">
                                    <span class="indicator-label">Edit {{ $vehicle->vin }}
