    ...
    <div class="w-100">
        <div class="pb-10 pb-lg-15">
            <h2 class="fw-bold d-flex align-items-center text-dark">Vehicle Damages
                <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="Here You will Edit Vehicle Damages"></i>
            </h2>
        </div>
        <div class="fv-row">
            <div class="row mb-10">
                <div class="col-12">
                    ...
                    <x-text-area rows="4" name="damage_description" id="damage_description">{{ $vehicle->vehicleDamage->damage_description }}</x-text-area>
