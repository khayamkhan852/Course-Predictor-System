        ...
        <div class="card">
            <div class="card-body">
                <div class="stepper stepper-links d-flex flex-column">
                    ...
                    <form class="mx-auto  w-100 pt-10 pb-10" id="add_vehicle_form" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="form-steps">
                            <div id="step-1" class="step" data-for-header="header1">
                                @include('admin.vehicle.create.partials.step-one')
                            </div>
                            <div id="step-2" class="step" data-for-header="header2" style="display: none;">
                                @include('admin.vehicle.create.partials.step-two')
                            </div>
                            <div id="step-3" class="step" data-for-header="header3" style="display: none;">
                                @include('admin.vehicle.create.partials.step-three')
                            </div>
                            <div id="step-4" class="step" data-for-header="header4" style="display: none;">
                                @include('admin.vehicle.create.partials.step-four')
                            </div>
                        </div>
