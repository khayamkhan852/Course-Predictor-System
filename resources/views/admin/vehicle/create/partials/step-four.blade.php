<div class="current">
    <div class="w-100">
        ...
        <div class="fv-row">
                ...
                <div class="col-sm-12 col-md-4 col-xl-4 col-lg-4 mb-10">
                    ...
                    <x-select-two class="form-select-solid" name="vehicle_status_id"  id="vehicle_status_id">
                        ...
                        @foreach($vehicleStatuses as $vehicleStatus)
                            <option value="{{ $vehicleStatus->id }}">{{ $vehicleStatus->status }}</option>
                        @endforeach
                    </x-select-two>
            ...
            <div class="row">
                <div class="col-sm-12 col-md-4 col-xl-4 col-lg-4 mb-10 owners" id="partner" style="display: none;">
                ...
                <div class="col-sm-12 col-md-4 col-xl-4 col-lg-4 mb-10 owners" id="company" style="display: none;">
                    ...
                    <x-select-two class="form-select-solid" name="business_setting_id"  id="business_setting_id">
                        ...
                        @foreach($businessSettings as $businessSetting)
                            <option value="{{ $businessSetting->id }}">{{ $businessSetting->name }}</option>
                        @endforeach
                    </x-select-two>
