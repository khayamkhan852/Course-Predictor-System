    ...
    <div class="w-100">
        ...
        <div class="fv-row">
            <div class="row mb-10">
                ...
                <br>
                <div class="col-12">
                    <x-image-preloaded name="vehicle_image" url="{{ asset('pictures/car.jpg') }}"  />
                </div> <br>
            ...
            <div class="row">
                <div class="col-sm-12 col-md-4 col-xl-4 col-lg-4 mb-10">
                    ...
                    <x-input class="form-control-solid" id="vehicle_type" name="vehicle_type"
                ...
                <div class="col-sm-12 col-md-4 col-xl-4 col-lg-4 mb-10">
                    ...
                    <x-input class="form-control-solid" id="engine_type" name="engine_type"
                ...
                <div class="col-sm-12 col-md-4 col-xl-4 col-lg-4 mb-10">
                    ...
                    <x-input class="form-control-solid" id="vin" name="vin"
            ...
            <div class="row">
                <div class="col-sm-12 col-md-4 col-xl-4 col-lg-4 mb-10">
                    ...
                    <x-input class="form-control-solid" id="color" name="color" placeholder="Vehicle Color" />
                    <div class="removeError text-danger" id="color_error"></div>
                </div>
                <div class="col-sm-12 col-md-4 col-xl-4 col-lg-4 mb-10">
                    <x-label for="model" class="required">Vehicle Model / Year</x-label>
                    <x-input class="form-control-solid" id="model" name="model" placeholder="Vehicle Model / Year" />
                    <div class="removeError text-danger" id="model_error"></div>
                </div>
                <div class="col-sm-12 col-md-4 col-xl-4 col-lg-4 mb-10">
                    <x-label for="brand" class="required">Vehicle Make / Brand</x-label>
                    <x-input class="form-control-solid" id="brand" name="brand" placeholder="Vehicle Brand / Make" />
            ...
            <div class="row">
                <div class="col-sm-12 col-md-4 col-xl-4 col-lg-4 mb-10">
                    ...
                    <x-input class="form-control-solid" id="fuel_capacity" name="fuel_capacity"
                ...
                <div class="col-sm-12 col-md-4 col-xl-4 col-lg-4 mb-10">
                    ...
                    <x-input class="form-control-solid" id="fuel_consumption" name="fuel_consumption"
                ...
                <div class="col-sm-12 col-md-4 col-xl-4 col-lg-4 mb-10">
                    ...
                    <x-input type="number" min="0" max="6" class="form-control-solid" id="doors" name="doors"
            ...
            <div class="row">
                <div class="col-sm-12 col-md-4 col-xl-4 col-lg-4 mb-10">
                    ...
                    <x-input type="number" min="0" class="form-control-solid" id="seats" name="seats"
                ...
                <div class="col-sm-12 col-md-4 col-xl-4 col-lg-4 mb-10">
                    ...
                    <x-input type="number" min="0" class="form-control-solid" id="large_bags" name="large_bags"
                ...
                <div class="col-sm-12 col-md-4 col-xl-4 col-lg-4 mb-10">
                    ...
                    <x-input type="number" min="0" class="form-control-solid" id="small_bags" name="small_bags"
                ...
                <div class="col-sm-12 col-md-4 col-xl-4 col-lg-4 mb-10">
                    ...
                    <x-select-two class="form-select-solid" name="vdrive_id[]"  id="vdrive_id" multiple>
                        ...
                        @foreach($vehicleDrives as $vehicleDrive)
                            <option value="{{ $vehicleDrive->id }}">{{ $vehicleDrive->vehicle_drive }}</option>
                        @endforeach
                    </x-select-two>
            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-4 col-xl-4 col-lg-4 mb-10">
                    ...
                    <x-input class="form-control-solid" id="imei" name="imei" placeholder="Tracker IMEI" />
                ...
                <div class="col-sm-12 col-md-4 col-xl-4 col-lg-4 mb-10">
                    ...
                    <x-select-two class="form-select-solid" name="flevel_id"  id="flevel_id">
                        ...
                        @foreach($fuelLevels as $fuelLevel)
                            <option value="{{ $fuelLevel->id }}">{{ $fuelLevel->level }}</option>
                        @endforeach
                    </x-select-two>
                ...
                <div class="col-sm-12 col-md-6 col-xl-6 col-lg-6 mb-10">
                    ...
                    <x-select-two class="form-select-solid" name="vtransmission_id[]"  id="vtransmission_id" multiple>
                        ...
                        @foreach($vehicleTransmissions as $vehicleTransmission)
                            <option value="{{ $vehicleTransmission->id }}">{{ $vehicleTransmission->v_transmission }}</option>
                        @endforeach
                    </x-select-two>
