...
@endsection
@section('content')
    <x-breadcrum name="User Types" parent="1" parent-name="Settings" page-name="User Types"
                 button-url="{{ route('admin.settings.roles.create') }}" button-text="Create" />
                                            ...
                                            <td class="text-center">
                                                ...
                                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true" style="">
                                                    <div class="menu-item px-3">
                                                        <a href="{{ route('admin.settings.roles.edit', [$role->id]) }}" class="menu-link px-3">Edit</a>
                                                    </div>

                                                    <div class="menu-item px-3">
                                                        <form method="POST" id="deleteForm{{ $role->id }}" action="{{ route('admin.settings.roles.destroy', [$role->id]) }}">
                                                            @csrf
                                                            @method('DELETE')
                                                        </form>
