                                ...
                                <div class="table-responsive">
                                    <table class="table align-middle table-row-bordered fs-6 gy-5">
                                        <tbody class="text-gray-600 fw-semibold">
                                            ...
                                            <tr>
                                                <td class="text-gray-800">Semesters</td>
                                                <td>
                                                    <div class="d-flex">
                                                        <label class="form-check form-check-sm form-check-custom form-check-solid me-5 me-lg-20">
                                                            <x-checkbox class="h-30px w-30px" name="permissions[]" value="semesters.view" is-checked="{{ in_array('semesters.view', $permissions, false) }}">
                                                                <span class="form-check-label">view</span>
                                                            </x-checkbox>
                                                        </label>
                                                        <label class="form-check form-check-sm form-check-custom form-check-solid me-5 me-lg-20">
                                                            <x-checkbox class="h-30px w-30px" name="permissions[]" value="semesters.create" is-checked="{{ in_array('semesters.create', $permissions, false) }}">
                                                                <span class="form-check-label">Create</span>
                                                            </x-checkbox>
                                                        </label>
                                                        <label class="form-check form-check-sm form-check-custom form-check-solid me-5 me-lg-20">
                                                            <x-checkbox class="h-30px w-30px" name="permissions[]" value="semesters.update" is-checked="{{ in_array('semesters.update', $permissions, false) }}">
                                                                <span class="form-check-label">Edit</span>
                                                            </x-checkbox>
                                                        </label>
                                                        <label class="form-check form-check-sm form-check-custom form-check-solid me-5 me-lg-20">
                                                            <x-checkbox class="h-30px w-30px" name="permissions[]" value="semesters.delete" is-checked="{{ in_array('semesters.delete', $permissions, false) }}">
                                                                <span class="form-check-label">Delete</span>
                                                            </x-checkbox>
                                                        </label>
                                                    </div>
                                            ...
                                            <tr>
                                                <td class="text-gray-800">Probation</td>
                                                <td>
                                                    <div class="d-flex">
                                                        <label class="form-check form-check-sm form-check-custom form-check-solid me-5 me-lg-20">
                                                            <x-checkbox class="h-30px w-30px" name="permissions[]" value="probation.view" is-checked="{{ in_array('probation.view', $permissions, false) }}">
                                                                <span class="form-check-label">View</span>
                                                            </x-checkbox>
                                                        </label>
                                                        <label class="form-check form-check-sm form-check-custom form-check-solid me-5 me-lg-20">
                                                            <x-checkbox class="h-30px w-30px" name="permissions[]" value="probation.create" is-checked="{{ in_array('probation.create', $permissions, false) }}">
                                                                <span class="form-check-label">Can Check Probation</span>
                                                            </x-checkbox>
                                                        </label>
                                                    </div>
                                                </td>
